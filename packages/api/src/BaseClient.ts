...
export class BaseClient {
   ...
   * @returns The API response
   */
  public submitTransaction<T extends Record<string, any>>(txn: string): Promise<T> {
   ...
   */
  public async handleTransactionRequest<T extends Record<string, any>>(endpoint: string, data?: Record<string, any>): Promise<T> {
